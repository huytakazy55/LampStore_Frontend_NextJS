        ...
        <>
            ...
            <main className='w-full mb-8 xl:mx-auto xl:max-w-[1440px] px-4 xl:px-0'>
                ...
                <nav className='flex items-center py-3 text-xs md:text-sm'>
                    <a href="/" className='font-medium text-gray-600 hover:text-primary-600 transition'>Trang chủ</a>
                ...
                <div className='flex items-center gap-3 mb-6'>
                    <h1 className='text-xl md:text-2xl font-medium text-gray-800'>
                        <i className='bx bxs-heart text-primary-500 mr-2'></i>
                        Danh sách yêu thích
                    </h1>
                    <span className='bg-primary-100 text-primary-700 text-sm px-3 py-0.5 rounded-sm font-medium'>
                                ...
                                <div key={item.id} className='bg-white rounded-sm shadow-sm border border-gray-100 overflow-hidden group hover:shadow-md transition-shadow'>
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            className='absolute top-2 right-2 w-8 h-8 bg-white/90 hover:bg-primary-50 rounded-sm flex items-center justify-center shadow-sm transition-colors cursor-pointer'
                                            title="Xóa khỏi yêu thích"
                                        >
                                            <i className='bx bxs-heart text-primary-500 text-lg'></i>
                                        </button>
                                    </div>
