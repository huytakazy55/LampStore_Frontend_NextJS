    ...
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4" onClick={handleCancel}>
      ...
      <div onClick={(e) => e.stopPropagation()}
        ...
        <div className="relative overflow-hidden rounded-lg bg-white dark:bg-gray-900 shadow-[0_25px_60px_rgba(0,0,0,0.3)]">
          ...
          {/* Header */}
          <div className="relative h-28 overflow-hidden bg-primary-600">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex gap-3">
                ...
                <button type="submit" disabled={loading}
                  className="flex-1 py-3 rounded-xl bg-primary-600 hover:bg-primary-700 text-white font-semibold text-sm shadow-lg shadow-primary-200/50 transition-all disabled:opacity-70 cursor-pointer">
                  {loading ? (
