                                        ...
                                        <div className='space-y-3 pt-3 border-t border-gray-100 dark:border-gray-800'>
                                            ...
                                            <div className='flex justify-end'>
                                                <button
                                                    ...
                                                    disabled={state.submitting}
                                                    className='px-4 py-2 bg-cta-600 text-white text-sm font-medium rounded-lg transition-colors disabled:opacity-50 cursor-pointer flex items-center gap-1.5 hover:shadow-[0_8px_20px_rgba(234,88,12,0.45)]'
                                                >
                                                    {state.submitting
