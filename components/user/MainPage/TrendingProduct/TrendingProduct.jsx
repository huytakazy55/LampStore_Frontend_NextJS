              ...
              <div key={product.id} className='p-[3px]'>
                ...
                >
                  ...
                  <div className='relative w-[40%] md:w-[42%] flex-shrink-0 bg-gray-50 dark:bg-[#111] overflow-hidden'>
                    {hasDiscount && (
                      <div className="absolute top-2 left-2 z-10 bg-cta-600 text-white text-[0.6rem] font-bold px-1.5 py-0.5 rounded-sm shadow-[0_2px_6px_rgba(234,88,12,0.25)]">
                        -{discountPercent}%
                      </div>
                    )}
                    <Image
                  ...
                  <div className='flex-1 flex flex-col py-3 px-3 md:py-4 md:px-4 min-w-0'>
                    ...
                    <div className='mt-auto flex items-end justify-between gap-2'>
                      <div className='flex flex-col gap-px'>
                        <span className='text-[0.9rem] md:text-[1rem] font-bold bg-primary-600 dark:bg-primary-400 text-transparent bg-clip-text inline-block leading-tight'>
                      ...
                      <div className='flex items-center gap-1.5'>
                        <button
                          className='w-7 h-7 md:w-8 md:h-8 rounded-sm bg-cta-600 dark:bg-cta-700 text-white flex items-center justify-center cursor-pointer transition-all duration-300 hover:shadow-[0_2px_8px_rgba(249,115,22,0.3)] active:scale-95'
                          onClick={(e) => {
                            e.stopPropagation();
                        ...
                        <button
                          className='w-7 h-7 md:w-8 md:h-8 rounded-sm bg-cta-600 dark:bg-cta-800 text-white dark:text-primary-300 flex items-center justify-center cursor-pointer transition-all duration-300 hover:text-white hover:shadow-[0_2px_8px_rgba(234,88,12,0.3)] active:scale-95'
                          onClick={(e) => {
                            e.stopPropagation();
