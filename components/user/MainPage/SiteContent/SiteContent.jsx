        ...
        <div className="md:hidden">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="bg-cta-600 text-white text-xs font-semibold px-5 py-2.5 rounded-sm transition-all duration-300 shadow-md active:scale-95 cursor-pointer flex items-center gap-1.5 hover:shadow-[0_8px_20px_rgba(234,88,12,0.45)]"
            >
              Khám Phá
          ...
          <div className="w-full lg:w-[55%]">
            ...
            <div className="flex flex-wrap items-center gap-4 md:gap-6">
              <button
                ...
                className="bg-cta-600 text-white text-xs md:text-sm font-semibold px-6 md:px-8 py-2.5 md:py-3 rounded-sm transition-all duration-300 hover:shadow-lg hover:shadow-primary-700/25 active:scale-95 cursor-pointer flex items-center gap-2"
              >
                Đặt mua ngay
