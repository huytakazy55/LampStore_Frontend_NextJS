            ...
            >
                  ...
                  {suggestions.categories.map((cat) => (
                    ...
                    >
                      <div className='w-7 h-7 rounded-lg bg-primary-100 dark:bg-primary-900/40 flex items-center justify-center flex-shrink-0 group-hover:bg-primary-200 dark:group-hover:bg-primary-800/50 transition-colors'>
                        <i className='bx bx-category bg-primary-600 dark:bg-primary-400 text-transparent bg-clip-text inline-block text-sm'></i>
                      </div>
                      <span className='text-sm text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white'>
                        Tìm trong danh mục <strong className='bg-primary-600 dark:bg-primary-400 text-transparent bg-clip-text inline-block'>"{cat.name}"</strong>
                      </span>
              ...
              {searchKeyword.trim() && (
                ...
                >
                  ...
                  <span className='text-sm font-medium bg-primary-600 dark:bg-primary-400 text-transparent bg-clip-text inline-block'>Xem tất cả kết quả cho "{searchKeyword}"</span>
                </div>
              )}
            </div>
          )}
                ...
                <div className='border-b border-gray-100 dark:border-gray-800'>
                  {suggestions.categories.map((cat) => (
                    <div key={`mcat-${cat.id}`} className='flex items-center gap-3 px-4 py-2.5 cursor-pointer hover:bg-primary-50 dark:hover:bg-primary-900/20 transition-colors' onClick={() => handleCategorySuggestionClick(cat)}>
                      <div className='w-6 h-6 rounded-lg bg-primary-100 dark:bg-primary-900/40 flex items-center justify-center flex-shrink-0'><i className='bx bx-category bg-primary-600 dark:bg-primary-400 text-transparent bg-clip-text inline-block text-xs'></i></div>
                      <span className='text-sm text-gray-700 dark:text-gray-300 truncate'>Danh mục <strong className='bg-primary-600 dark:bg-primary-400 text-transparent bg-clip-text inline-block'>"{cat.name}"</strong></span>
                    </div>
                  ))}
                </div>
              )}
