...
const FormLogin = ({ toggleLogin, setToggleLogin }) => {
    ...
    return (
        <>
            ...
            `}</style>
            <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4" onClick={handleModalClose}>
                <div className="absolute inset-0 bg-black/50 backdrop-blur-sm" />

                <div onClick={e => e.stopPropagation()} className="relative z-10 w-full max-w-[820px]" style={{ animation: 'fl-open .3s ease' }}>
                    <div className="relative overflow-hidden rounded-3xl bg-white dark:bg-gray-900 shadow-[0_30px_80px_rgba(0,0,0,0.3)]" style={{ minHeight: 480 }}>
                        ...
                        <div className="relative w-full" style={{ minHeight: 480 }}>
                            ...
                            <div className={`w-full sm:w-1/2 sm:absolute sm:top-0 sm:bottom-0 sm:left-0 transition-opacity duration-500 ${changeForm ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
                                <div className="px-8 sm:px-10 py-8 sm:py-10 flex flex-col justify-center h-full">
                                    <div className="mb-6">
                                        <h3 className="text-2xl font-bold text-amber-600 dark:text-amber-400 mb-1">Đăng nhập</h3>
                            ...
                            <div className={`w-full sm:w-1/2 sm:absolute sm:top-0 sm:bottom-0 sm:right-0 transition-opacity duration-500 ${!changeForm ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
                                <div className="px-8 sm:px-10 py-8 sm:py-10 flex flex-col justify-center h-full">
                                    <div className="mb-6">
                                        <h3 className="text-2xl font-bold text-amber-600 dark:text-amber-400 mb-1">Tạo tài khoản</h3>
                                        <p className="text-gray-400 text-sm">Đăng ký để bắt đầu mua sắm</p>
                                    </div>
                                    <form onSubmit={handleSignup} autoComplete="nope">
                                        ...
                                        <label className="flex items-start gap-2 mb-6 cursor-pointer select-none">
                                            ...
                                            <span className="text-xs text-gray-500 leading-relaxed">Tôi đồng ý với <a href="#" className="text-amber-600 hover:underline font-medium">Điều khoản sử dụng</a> và <a href="#" className="text-amber-600 hover:underline font-medium">Chính sách bảo mật</a></span>
                                        </label>
                                        <button type="submit" disabled={isLoading} className="w-full py-3 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-semibold text-sm shadow-lg shadow-amber-200/50 dark:shadow-amber-900/30 transition-all duration-300 disabled:opacity-70 cursor-pointer active:scale-[0.97] hover:-translate-y-0.5">
                                        ...
                                        <p className="text-center text-sm text-gray-500 mt-5 sm:hidden">Đã có tài khoản?{' '}<button type="button" onClick={ChangeFormLogin} className="text-amber-600 font-semibold cursor-pointer">Đăng nhập</button></p>
                                    </form>
                                </div>
                            </div>
                        </div>
