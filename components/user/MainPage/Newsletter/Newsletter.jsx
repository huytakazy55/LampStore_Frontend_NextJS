...
{
    return (
        <div className='mt-8 md:mt-16 bg-gradient-to-r from-primary-600 via-tertiary-500 to-quaternary-500 shadow-lg shadow-primary-500/20'>
            <div className='flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0 py-5 md:py-0 md:h-20 xl:mx-auto xl:max-w-[1440px] px-6 xl:px-0'>
                <div className='text-sm md:text-lg font-bold flex justify-center items-center gap-3 md:gap-4 text-white'>
                    <div className='w-10 h-10 rounded-full bg-white/20 flex items-center justify-center'>
                        <i className='bx bxl-telegram text-xl text-white'></i>
                    </div>
                    <span>Đăng ký nhận tin</span>
                </div>
                <div className='text-xs md:text-sm text-center md:text-left text-white'>
                    ...và nhận <b className='text-white'>ưu đãi 20% cho đơn hàng đầu tiên</b>
                </div>
