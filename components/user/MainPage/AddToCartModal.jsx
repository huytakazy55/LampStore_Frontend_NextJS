                    ...
                    <div className="w-full md:w-3/5 p-3 sm:p-6 flex flex-col">
                        ...
                        <div className="flex items-end gap-3 mt-1 sm:mt-2 mb-3 sm:mb-5 bg-primary-50/50 dark:bg-primary-900/20 p-2.5 sm:p-4 rounded-md border border-primary-100/50 dark:border-primary-800/30">
                            ...
                            {hasDiscount && (
                                <>
                                    ...
                                    <span className="bg-primary-500 text-white text-xs px-1.5 py-0.5 rounded font-medium mb-1">
                                        -{discountPercent}%
                                    </span>
                                </>
                            )}
                        ...
                        <div className="mt-auto flex gap-3 sm:gap-4 pt-3 sm:pt-4 border-t border-gray-100 dark:border-gray-800">
                            <button
                                ...
                                className="flex-1 bg-primary-50 dark:bg-primary-900/30 border border-primary-500 text-primary-600 dark:text-primary-400 py-2.5 sm:py-3 rounded-md font-medium hover:bg-primary-100 dark:hover:bg-primary-900/50 transition-colors flex justify-center items-center gap-2 cursor-pointer text-sm sm:text-base"
                            >
                            ...
                            <button
                                ...
                                className="flex-1 bg-primary-500 text-white py-2.5 sm:py-3 rounded-md font-medium hover:bg-primary-600 transition-colors shadow-sm cursor-pointer text-sm sm:text-base"
                            >
                                Mua ngay
                            </button>
                        </div>
