    ...
    <div className='flex justify-between gap-2 md:gap-[10px]'>
      ...
      <div className='w-8/12'>
        ...
        <div className='flex justify-between items-center mb-1 md:mb-[10px]'>
          ...
          <div className='group-hover:bg-primary-500 w-7 h-7 md:w-8 md:h-8 bg-gray-300 rounded-[50%] leading-[1.5] text-white cursor-pointer mr-2 md:mr-4 mt-2 md:mt-3 flex items-center justify-center'>
    ...
    <div className='w-full bg-banner-product bg-cover bg-center mb-6 md:mb-10'>
        <nav className='xl:mx-auto xl:max-w-[1440px] flex flex-col md:flex-row justify-between items-stretch h-auto md:h-[36rem] py-4 md:py-8 px-4 xl:px-0 gap-4 md:gap-0'>
            ...
            <div className='w-full md:w-1/2 text-sm md:text-h3'>
                <div className='relative font-medium text-black border-b border-gray-300 pb-1 mb-4 md:mb-6 after:absolute after:w-[39%] after:h-[1px] after:bg-primary-500 after:bottom-0 after:left-0 text-sm md:text-base'>Television Entertainment</div>
