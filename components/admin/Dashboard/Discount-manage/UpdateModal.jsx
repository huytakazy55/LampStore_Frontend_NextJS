    ...
    const handleOk = async () => {
        try {
            ...
            const payload = {
                ...
                discountPercentage: values.discountType === 'Percentage' ? (values.discountPercentage || 0) : 0,
                discountAmount: values.discountType === 'FixedAmount' ? (values.discountAmount || 0) : 0,
