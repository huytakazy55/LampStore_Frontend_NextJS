        ...
        <article className="prose prose-gray dark:prose-invert max-w-none prose-headings:text-gray-800 dark:prose-headings:text-gray-100">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-gray-100 mb-2 flex items-center gap-3">
                <span className="w-10 h-10 bg-primary-100 dark:bg-primary-900/40 rounded-xl flex items-center justify-center shrink-0">
                    <i className='bx bx-package text-primary-600 dark:text-primary-400 text-xl' />
                </span>
                ...
                <table className="w-full text-sm border-collapse">
                    <thead>
                        <tr className="bg-primary-50 dark:bg-primary-950/30">
                            <th className="text-left p-3 font-semibold text-gray-800 dark:text-gray-100 border-b border-primary-100 dark:border-primary-800/40">Khu vực</th>
                            ...
                            <th className="text-left p-3 font-semibold text-gray-800 dark:text-gray-100 border-b border-primary-100 dark:border-primary-800/40">Phí ship</th>
                        </tr>
                    </thead>
            ...
            <div className="bg-primary-50 dark:bg-primary-950/30 rounded-2xl p-6 mb-8 border border-primary-100 dark:border-primary-800/40 not-prose">
                <div className="flex items-start gap-3">
                    <i className='bx bxs-truck text-primary-600 dark:text-primary-400 text-2xl mt-0.5' />
                    <div>
                        <h4 className="font-bold text-primary-800 dark:text-primary-300 mb-1">Miễn phí vận chuyển</h4>
                        <p className="text-primary-700 dark:text-primary-400 text-sm leading-relaxed">Đơn hàng từ <strong>500.000đ</strong> trở lên được <strong>miễn phí vận chuyển</strong> toàn quốc! Áp dụng cho tất cả phương thức thanh toán.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="not-prose grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                {[
                    ...
                    <div key={i} className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700">
                        <div className="w-8 h-8 bg-primary-100 dark:bg-primary-900/40 rounded-lg flex items-center justify-center mb-3">
                ...
                {[
                    ...
                    <div key={i} className="flex items-start gap-4 p-5 bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700">
                        <div className="w-10 h-10 bg-primary-100 dark:bg-primary-900/40 rounded-lg flex items-center justify-center shrink-0">
                            <i className={`bx ${method.icon} text-primary-600 dark:text-primary-400 text-xl`} />
                        </div>
                        <div className="flex-1">
                            <div className="flex items-center gap-2 mb-1">
                                <h4 className="font-semibold text-gray-800 dark:text-gray-100 text-sm">{method.title}</h4>
                                {method.tag && <span className="text-xs bg-primary-100 dark:bg-primary-900/40 text-primary-700 dark:text-primary-400 px-2 py-0.5 rounded-full font-medium">{method.tag}</span>}
                            </div>
