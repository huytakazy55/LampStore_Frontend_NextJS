        ...
        <article className="prose prose-gray dark:prose-invert max-w-none prose-headings:text-gray-800 dark:prose-headings:text-gray-100">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-gray-100 mb-2 flex items-center gap-3">
                <span className="w-10 h-10 bg-primary-100 dark:bg-primary-900/40 rounded-xl flex items-center justify-center shrink-0">
                    <i className='bx bx-cart text-primary-600 dark:text-primary-400 text-xl' />
                </span>
                Hướng dẫn chọn mua
            </h2>
                ...
                {[
                    ...
                    <div key={i} className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl p-5 shadow-sm">
                        <div className="w-10 h-10 bg-primary-100 dark:bg-primary-900/40 rounded-lg flex items-center justify-center mb-3">
                            <i className={`bx ${item.icon} text-primary-600 dark:text-primary-400 text-xl`} />
                        </div>
                ...
                <table className="w-full text-sm border-collapse">
                    <thead>
                        <tr className="bg-primary-50 dark:bg-primary-950/30">
                            <th className="text-left p-3 font-semibold text-gray-800 dark:text-gray-100 border-b border-primary-100 dark:border-primary-800/40">Phân khúc</th>
                            <th className="text-left p-3 font-semibold text-gray-800 dark:text-gray-100 border-b border-primary-100 dark:border-primary-800/40">Mức giá</th>
                            <th className="text-left p-3 font-semibold text-gray-800 dark:text-gray-100 border-b border-primary-100 dark:border-primary-800/40">Đặc điểm</th>
                        </tr>
                    </thead>
